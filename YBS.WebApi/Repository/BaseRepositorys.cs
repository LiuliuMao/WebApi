...
namespace Repository
{
    public class BaseRepositorys<T> : IBaseRepositorys<T> where T : class
    {
        ...
        public BaseRepositorys(ISqlServerDBContext mydbcontext)
        {
            _dbContext = mydbcontext as SqlServerDBContext;
            if (_dbContext == null)
            {
                return;
            }
        ...
        public string ConnectionString
        {
            get
            {
                return this.connectionString ?? this._dbContext.Database.GetDbConnection().ConnectionString;
            }
            set
            {
                this.connectionString = value;
                _dbContext.Database.GetDbConnection().ConnectionString = this.connectionString;
            }
        }
